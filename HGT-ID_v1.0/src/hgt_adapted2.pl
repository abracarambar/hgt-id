...
&extract_regions($readlength, $libsize, $OUTPUT, $VIRUS_HUMAN_database,$HUMAN_database, $chrflag, $BAMFILE, $human_mapping_again, $viral_mapping, $THREADS, $CYTOBAND);
...
sub extract_regions {
	my ($readlength, $libsize, $OUTPUT, $VIRUS_HUMAN_database,$HUMAN_database, $chrflag, $BAMFILE, $human_mapping_again, $viral_mapping, $THREADS, $CYTOBAND) = @_;
...
sub extractsoftclippedreadsfromhumanbam {
	my $BAMFILE, $human_mapping, $THREADS, $PICARD, $logs = @_;
